        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: [
              ...
              `})(window,document,'script','https://mc.yandex.ru/metrika/tag.js?id=110283298','ym');`,
              `ym(110283298,'init',{ssr:true,webvisor:true,clickmap:true,ecommerce:"dataLayer",referrer:document.referrer,url:location.href,accurateTrackBounce:true,trackLinks:true});`,
            ].join(" "),
          }}
        />
        <noscript>
