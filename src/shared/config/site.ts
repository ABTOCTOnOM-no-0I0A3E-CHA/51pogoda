export const SITE = {
  ...
  url: (process.env.NEXT_PUBLIC_SITE_URL ?? "https://pogoda-zapolyarya.ru").replace(/\/+$/, ""),
...
export const MET_USER_AGENT =
  process.env.MET_USER_AGENT ?? "PogodaZapolyarya/1.0 (+https://pogoda-zapolyarya.ru; contact@pogoda-zapolyarya.ru)";
